...
.overlay__container.filmstrip-only {
...
.dialog .form-control:not(:last-child) {
	border-bottom: 1px solid #64449C
}
...
.dialog .aui-dialog2-content h3,
.dialog .aui-dialog2-content p,
.dialog .aui-dialog2-content span {
	font-weight: 400
}
...
.feedback-dialog .rating .star-btn.active,
.feedback-dialog .rating .star-btn.starHover,
.feedback-dialog .rating .star-btn:hover {
	color: #36B37E
}
...
.info-dialog .info-dialog-action-link {
	display: inline-block;
	line-height: 1.5em
}

.info-dialog .info-dialog-action-link a {
	cursor: pointer;
	vertical-align: middle
}

.info-dialog .info-dialog-action-link:before {
	color: #489afe;
	content: '\2022';
	font-size: 1.5em;
	padding: 0 10px;
...
.info-dialog .info-dialog-action-link:first-child:before {
	content: '';
	padding: 0
}

.info-dialog .info-dialog-action-links {
	font-weight: 700;
	margin-top: 10px;
	white-space: nowrap
}

.info-dialog .info-dialog-action-separator {
	display: inline-block
}

.info-dialog .info-dialog-copy-element {
	opacity: 0;
	pointer-events: none;
	position: absolute;
	-webkit-user-select: text;
...
.info-dialog .info-dialog-dial-in .conference-id,
.info-dialog .info-dialog-dial-in .phone-number,
...
.info-dialog .info-dialog-conference-url,
.info-dialog .info-dialog-live-stream-url {
	width: max-content;
...
.info-dialog .info-dialog-dial-in {
	word-break: break-all
}

.info-dialog .info-dialog-icon {
	color: #6453C0;
	font-size: 16px;
	min-width: 30px
}

.info-dialog .info-dialog-url-text,
.info-dialog .info-dialog-url-text:hover {
	color: inherit;
	cursor: inherit
}

.info-dialog .info-dialog-url-icon {
	display: inline-block;
	margin-left: 5px
}

.info-dialog .info-dialog-url-icon svg {
	cursor: pointer
}
...
.dial-in-page .info-dialog-url-text-unselectable,
.info-dialog .info-dialog-url-text-unselectable {
	user-select: none;
...
.videocontainer__toolbar .indicator-container,
...
.videocontainer__toptoolbar .connection-indicator .connection_empty,
.videocontainer__toptoolbar .connection-indicator .connection_lost,
...
.videoMessageFilter {
	-webkit-filter: grayscale(.5) opacity(.8);
...
#remotePresenceMessage .presence-label {
	opacity: .8;
	text-shadow: 0 0 1px rgba(0, 0, 0, .3), 0 1px 1px rgba(0, 0, 0, .3), 1px 0 1px rgba(0, 0, 0, .3), 0 0 1px rgba(0, 0, 0, .3);
	background: rgba(0, 0, 0, .5);
	border-radius: 5px;
	padding: 5px 10px
}
...
.participants-count-icon {
	background: url(../images/user-groups.svg) no-repeat;
	display: inline-block;
	height: 16px;
	width: 16px
}
...
.popupmenu__contents:hover,
.popupmenu__link:hover {
	background-color: rgba(255, 255, 255, .1);
	color: #fff!important
}

.popupmenu__contents.disabled,
.popupmenu__link.disabled {
	pointer-events: none
}
...
.ringing {
	...
	position: fixed;
	z-index: 300;
	background-color: rgba(40, 52, 71, .95)
}
...
.disabled .new-toolbox .toolbox-content .button-group-center .toolbox-button .toolbox-icon,
.new-toolbox .toolbox-content .button-group-center .toolbox-button .toolbox-icon.disabled {
	cursor: initial;
	color: #fff;
...
.connection-info__download,
.connection-info__icon,
.connection-info__upload {
	margin-right: 2px
}
...
.filmstrip__videos .videocontainer:hover:not(.videoContainerFocused):not(.active-speaker) {
	cursor: hand;
	border: 2px solid rgba(22, 94, 204, .4);
	box-shadow: inset 0 0 3px rgba(22, 94, 204, .4), 0 0 3px rgba(22, 94, 204, .4)
}
...
.tile-view .filmstrip__videos .videocontainer:hover:not(.active-speaker),
.tile-view .filmstrip__videos .videocontainer:not(.active-speaker) {
	border: none;
	box-shadow: none
}
...
.chrome-extension-banner {
	...
	height: 128px;
	background: #FFF;
	box-shadow: 0 2px 48px rgba(0, 0, 0, .25);
	border-radius: 4px;
	z-index: 1000;
	float: right;
	display: flex;
...
.chrome-extension-banner__icon-container {
	display: flex;
	background: url(../images/chromeLogo.svg) no-repeat;
	width: 27px;
	height: 27px
}
...
.disabled .settings-button-container .toolbox-icon,
.settings-button-container .toolbox-icon.disabled {
	cursor: initial;
	color: #fff;
	background-color: #a4b8d1
}
